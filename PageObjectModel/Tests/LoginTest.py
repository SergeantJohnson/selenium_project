...
class ut(unittest.TestCase):
    ...
    def test_a_login(self):
        ...
        self.driver.find_element(By.ID, loginProp.username_text_field_id).send_keys("abcd@gmail.com")
        self.driver.find_element(By.ID, loginProp.password_text_field_id).send_keys("password")
